...
for epoch in range(nb_epochs):
    ...
    loss = torch.linalg.vector_norm(x0[:,0:2] - pred)
...
# Save checkpoint of MLP
torch.save(mlp.state_dict(), "checkpoints/mlp_checkpoint_3.pth")

# mlp.load_state_dict(torch.load("checkpoints/mlp_checkpoint_2.pth"))
