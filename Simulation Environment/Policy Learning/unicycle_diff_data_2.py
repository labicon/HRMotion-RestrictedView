...
def main():
    ...
    np.savetxt("data2/positions.csv", position_array, delimiter=",",fmt ='% s')
    np.savetxt("data2/controls.csv", controls_array, delimiter=",",fmt ='% s')
    np.savetxt("data2/obstacles.csv", obstacles_array, delimiter=",",fmt ='% s')
